...
def dump_all(ws):
    ...
    print("Recording interval : {i} minute(s)".format(i=ws.recording_interval()))
    print("Forecast is {f} with {t} trends".format(f=ws.forecast(), t=ws.tendency()) )
    print("")
...
if __name__ == "__main__":
    ...
    ser = serial.Serial(baudrate=300, port=options.DEVICE, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=None, writeTimeout=None, interCharTimeout=None, rtscts=0, dsrdtr=None, xonxoff=0)
