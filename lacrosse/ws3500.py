...
class WS3500():
    ...
    def _read_safe(self, address, number):
        self.logger.info("_read_safe(%s,%s)",address, number)
        readdata = ''
        readdata2 = ''
        self.count_failed_differs = 0
        self.count_failed_zeroes = 0
    ...
    def _get_pressure(self, address):
